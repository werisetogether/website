...
const Footer = () => {
	...
	return (
		<footer className="bg-gray-800 text-white flex-1">
			<div className="max-w-5xl mx-auto py-5 px-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-4">
					<div>
						<div className="flex flex-row gap-2">
							<Link href={``}>
								<svg className="aspect-square w-8 hover:text-gray-300 cursor-pointer" viewBox="0 0 20 20">
									<path
										fill="currentColor"
				...
				<p className="text-sm pt-6 md:pt-0">&copy; {moment().year()} We Rise Together. All rights reserved.</p>
			</div>
		</footer>
	);
};
