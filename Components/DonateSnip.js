  ...
  return (
    <div className="max-w-4xl mx-auto mt-24">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 items-center gap-4 mt-7 sm:mt-12">
        <Link href="">
          <a className="font-medium text-2xl sm:text-4xl text-center rounded-xl py-5 leading-relaxed bg-gray-200">
            Rs 180
          </a>
        </Link>
        <Link href="">
        ...
        <Link href="">
          <a className="sm:col-span-3 font-medium text-2xl sm:text-4xl text-center rounded-xl py-5 leading-relaxed bg-redBtn">
            Custom
          </a>
        </Link>
      </div>
